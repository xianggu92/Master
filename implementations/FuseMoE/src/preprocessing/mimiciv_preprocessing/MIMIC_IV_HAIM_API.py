...
biobert_path = '/mnt/data/yihua/.cache/huggingface/hub/models--emilyalsentzer--Bio_ClinicalBERT/snapshots/d5892b39a4adaed74b92212a44081509db72f87b'
biobert_tokenizer = AutoTokenizer.from_pretrained(biobert_path)
biobert_model = AutoModel.from_pretrained(biobert_path).to('cuda:3')
...
def get_biobert_embeddings(text):
    ...
    tokens_pt = biobert_tokenizer(text, return_tensors="pt").to('cuda:3')
