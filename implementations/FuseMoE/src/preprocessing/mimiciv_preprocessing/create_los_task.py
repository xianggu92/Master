...
# imputed_vitals = pd.read_pickle(os.path.join(preprocessing_dir, "imputed_ts_vitals_icu.pkl"))
...
if include_notes:
    ...
    # notes_df = pd.read_pickle(os.path.join(preprocessing_dir, "notes_text.pkl"))
