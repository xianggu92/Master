...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="../run", help="Where to store the final model.")
    parser.add_argument("--run_name", type=str, required=True, help="Experiment name used as the third-level output directory.")
